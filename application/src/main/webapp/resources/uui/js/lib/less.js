...
(function (e, t) {
    ...
    function w(t, n, i, s) {
        var o = t.contents || {}, u = t.files || {}, a = b(t.href, e.location.href), f = a.url, c = l && l.getItem(f),
            h = l && l.getItem(f + ":timestamp"), p = {css: c, timestamp: h}, d;
    ...
    function k(e, t) {
        var n = "less-error-message:" + E(t), i = '<li><label>{line}</label><pre class="{class}">{content}</pre></li>',
            s = document.createElement("div"), o, u, a = [], f = e.filename || t, l = f.match(/([^\/]+(\?.*)?)$/)[1];
    ...
    (function (e) {
        ...
        e.functions = {
            rgb: function (e, t, n) {
                ...
                var i = r.value / 100, s = i * 2 - 1, o = t.toHSL().a - n.toHSL().a,
                    u = ((s * o == -1 ? s : (s + o) / (1 + s * o)) + 1) / 2, a = 1 - u,
                ...
                var n = Math.abs(e.rgb[0] - t.rgb[0]), r = Math.abs(e.rgb[1] - t.rgb[1]),
                ...
                var n = 255 - Math.abs(255 - t.rgb[0] - e.rgb[0]), r = 255 - Math.abs(255 - t.rgb[1] - e.rgb[1]),
        ...
        e.Color = function (e, t) {
            ...
            eval: function () {
                ...
                var e = this.rgb[0] / 255, t = this.rgb[1] / 255, n = this.rgb[2] / 255, r = this.alpha,
                    i = Math.max(e, t, n), s = Math.min(e, t, n), o, u, a = (i + s) / 2, f = i - s;
                if (i === s) o = u = 0; else {
                    u = a > .5 ? f / (2 - i - s) : f / (i + s);
                    switch (i) {
                        case e:
