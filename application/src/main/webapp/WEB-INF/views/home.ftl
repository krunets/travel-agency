    ...
    <div class="margin-bottom">
        ...
        <table id="example" class="table">
                    ...
                    <ul class="horizontal-center-container pagination">
                        <#if tourPaginationDTO.page gt 1>
                            <li class="page-item"><a class="page-link"
                                                     onclick="insertParam('page', ${tourPaginationDTO.page-1})"><@spring.message "previous.message"/></a>
                            </li>
                        </#if>
                        <#if tourPaginationDTO.page < tourPaginationDTO.pageAmount>
                         <li class="page-item"><a class="page-link"
                                                  onclick="insertParam('page', ${tourPaginationDTO.page+1})"><@spring.message "next.message"/></a>
                         </li>
                        </#if>
            ...
            <tr>
                ...
                <@security.authorize access="hasRole('ROLE_ADMIN')">
                    <th scope="col"><@spring.message "edit.message"/></th>
                    <th scope="col"><@spring.message "delete.message"/></th>
                </@security.authorize>
            </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>${tour.duration.toDays()}<@spring.message "day.message"/></td>
                    <td>${tour.tourType}</td>
                    <td>
                    ...
                    <@security.authorize access="hasRole('ROLE_ADMIN')">
                        <td>
                            <p data-placement="top" data-toggle="tooltip" title="<@spring.message "edit.message"/>">
                                <button class="edit-modal btn btn-primary btn-xs" data-title="Edit"
                                        ...
                                        data-tour-duration="${tour.duration.toDays()}<@spring.message "day.message"/>"
