...
public class HotelRepository extends AbstractRepository<Hotel, Integer> {
	private static List<Hotel> hotels = new ArrayList<>(Arrays.asList(
			...
			new Hotel<Integer>(2, "DoubleTree by Hilton", "232 12 12", 5, new Country<Integer>()),
			new Hotel<Integer>(3, "Prezident-Otel", "111 11 11" , 4, new Country<Integer>()),
			new Hotel<Integer>(4, "Aqua-Minsk", "123 11 11", 2, new Country<Integer>()),
			new Hotel<Integer>(5, "Trump International Hotel Washington DC", "101 10 01", 5, new Country<Integer>())));
