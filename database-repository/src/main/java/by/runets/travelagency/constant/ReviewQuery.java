...
public class ReviewQuery {
	...
	public static final String READ_ALL_REVIEW = "SELECT * FROM travel_agency.review AS r JOIN travel_agency.user AS u ON u.u_id = r.r_id";
	public static final String READ_REVIEW_BY_ID = "SELECT * FROM travel_agency.review AS r JOIN travel_agency.user AS u ON u.u_id = r.r_id WHERE r.r_id=?";
