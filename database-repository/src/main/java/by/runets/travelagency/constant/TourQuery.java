...
public class TourQuery {
	...
	public static final String READ_ALL_TOUR = "SELECT t.t_id, photo, date, description, duration, cost, t_type, u.u_id, login, password, c.c_id, c_name " +
			"FROM travel_agency.tour AS t " +
			...
			"ORDER BY t.t_id";
	public static final String READ_TOUR_BY_ID = "SELECT t.t_id, photo, date, description, duration, cost, t_type, u.u_id, login, password, c.c_id, c_name " +
			"FROM travel_agency.tour AS t " +
			"LEFT JOIN travel_agency.tour_m2m_user AS tm2mu ON tm2mu.t_id = t.t_id " +
			"LEFT JOIN travel_agency.\"user\" AS u ON tm2mu.u_id = u.u_id " +
			"LEFT JOIN travel_agency.tour_m2m_country AS tm2mc ON tm2mc.t_id = t.t_id " +
