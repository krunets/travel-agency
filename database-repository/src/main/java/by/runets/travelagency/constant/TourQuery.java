...
public class TourQuery {
	...
	public static final String DELETE_TOUR_M2M_COUNTRY = "DELETE FROM travel_agency.tour_m2m_country WHERE t_id = ?";
	public static final String DELETE_TOUR_M2M_USER = "DELETE FROM travel_agency.tour_m2m_user WHERE t_id = ?";
}
